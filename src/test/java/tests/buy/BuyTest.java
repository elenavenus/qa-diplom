...
public class BuyTest {
    ...
    void shouldApprove() {
        ...
        $("div.notification_status_ok div.notification__content").should(Condition.appear, Duration.ofSeconds(20)).shouldHave(Condition.text("Операция одобрена Банком."));
    }
    ...
    void shouldDeclined(){
        ...
        buyPage.continueButtonCLick();
        $("div.notification_status_error div.notification__content").should(Condition.appear, Duration.ofSeconds(20)).shouldHave(Condition.text("Ошибка! Банк отказал в проведении операции."));
    }
